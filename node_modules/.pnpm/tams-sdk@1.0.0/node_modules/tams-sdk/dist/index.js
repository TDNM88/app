...
__export(src_exports, {
  Sha256RsaAuthenticateStrategy: () => Sha256RsaAuthenticateStrategy,
  TamsSDK: () => TamsSDK,
  t: () => tams_exports
});
...
${body}`;
    ...
    return new import_node_fetch_native.Headers({
...
var TamsSDK = class {
  ...
  constructor(options) {
    ...
    this.api = new Api({
      ...
      customFetch: async (...fetchParams) => {
        ...
        const nextHeaders = new import_node_fetch_native.Headers(init.headers || {});
        headers.forEach((v, k) => {
          nextHeaders.append(k, v);
        });
        fetchParams[1].headers = nextHeaders;
        const resp = await import_node_fetch_native.fetch.apply(globalThis, fetchParams);
        return resp;
      }
    });
  }
  ...
  async uploadFile({
    ...
    if (Buffer.isBuffer(file)) {
      file = new import_node_fetch_native.Blob([file]);
    }
    const uploadResp = await (0, import_node_fetch_native.fetch)(resp.data.putUrl, {
